...
\item
  the \code{-AuseSafeDefaultsForUnannotatedSourceCode} command-line
...
the annotation definitions (e.g., the \code{checker-framework.jar}
or \code{checker-qual.jar} file) must be on the classpath.
(This is done automatically if you use the Checker Framework comiler.)
